...
public class VisualArrayLists implements ActionListener {
	...
	public void addThingsToList() {
		...
		list.add("Buy Mallet");
		list.add("Rent a Limo");
		list.add("Play Brawl Stars");
		list.add("Christmas Break!!!");
		// 2. Set one item in our list to be something different
		list.set(1, "Rent a Tesla");
		...
		if(list.contains("Christmas Break")) {
			System.out.println("The good stuff is in the list!");
		}
		else {
			System.out.println("The good stuff not in the list.");
		}
